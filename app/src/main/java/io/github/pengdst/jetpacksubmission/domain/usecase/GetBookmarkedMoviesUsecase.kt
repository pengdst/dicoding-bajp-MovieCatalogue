 ...
 */
class GetBookmarkedMoviesUsecase @Inject constructor(private val repository: MovieRepository): UseCase<PagingData<Movie>, GetBookmarkedMoviesUsecase.Companion>() {
    companion object;
