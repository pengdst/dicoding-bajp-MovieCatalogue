 ...
 */
class GetBookmarkedTvShowsUsecase @Inject constructor(private val repository: MovieRepository): LiveDataUseCase<List<TvShow>, GetBookmarkedTvShowsUsecase.Companion>() {
    companion object;
