 ...
 */
class GetUpcomingMoviesUsecase @Inject constructor(private val repository: MovieRepository): LiveDataUseCase<Resource<List<Movie>>, GetUpcomingMoviesUsecase.Companion>() {
    companion object;
